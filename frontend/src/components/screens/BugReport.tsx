        ...
        <MainLayout>
            <div className="p-6 pt-4 pb-32">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h1 className="text-xl font-black text-white">Report a Bug</h1>
                </div>
                ...
                <div className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <select className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-sm font-bold text-white outline-none focus:border-primary/50 appearance-none">
                ...
                <div className="mt-10">
                    <Button
                        ...
                        className="py-5 text-xl gap-3 shadow-[0_10px_30px_rgba(242,204,13,0.3)] font-black italic tracking-widest"
                    >
                        <Send size={20} />
                        SUBMIT REPORT
                    </Button>
